...
from beam_search import (
    ...
    modified_beam_search_lm_clm_shallow_fusion,
)
...
def decode_one_batch(
    ...
    if (
        ...
        for hyp in sp.decode(hyp_tokens):
            hyps.append(hyp.split())
    elif params.decoding_method == "modified_beam_search_lm_clm_shallow_fusion":
        hyp_tokens = modified_beam_search_lm_clm_shallow_fusion(
            model=model,
            encoder_out=encoder_out,
            encoder_out_lens=encoder_out_lens,
            beam=params.beam_size,
