...
def compute_loss(
    ...
    with torch.set_grad_enabled(is_training):
        simple_loss, pruned_loss, nll_loss = model(
            x=feature,
            x_lens=feature_lens,
        ...
        is_finite = simple_loss_is_finite & pruned_loss_is_finite & nll_loss_is_finite
        ...
        loss = params.simple_loss_scale * simple_loss + pruned_loss_scale * pruned_loss + params.nll_loss_scale * nll_loss
